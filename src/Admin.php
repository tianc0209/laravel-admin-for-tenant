...
use Closure;
use Tianc\Admin\Auth\Database\Menu;
use Tianc\Admin\Controllers\AuthController;
use Tianc\Admin\Layout\Content;
use Tianc\Admin\Traits\HasAssets;
use Tianc\Admin\Widgets\Navbar;
...
class Admin
{
     ...
     * @param Closure $callable
     *
     * @return \Tianc\Admin\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \Tianc\Admin\Widgets\Navbar
     */
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\Tianc\Admin\Controllers')->group(function ($router) {
