...
<header class="main-header">
    ...
    <a href="{{ admin_url('/') }}" class="logo">
        ...
        <span class="logo-mini">{!! config('tenant-admin.logo-mini', config('tenant-admin.name')) !!}</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">{!! config('tenant-admin.logo', config('tenant-admin.name')) !!}</span>
    </a>
