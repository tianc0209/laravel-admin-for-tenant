...
`Tianc\Admin\Widgets\Box` used to generate box components:
...
`Tianc\Admin\Widgets\Collapse` class used to generate folding components:
```php
use Tianc\Admin\Widgets\Collapse;
...
`Tianc\Admin\Widgets\Form` class is used to quickly build a form:
...
`Tianc\Admin\Widgets\InfoBox` class is used to generate the information presentation block:

```php
use Tianc\Admin\Widgets\InfoBox;
...
`Tianc\Admin\Widgets\Tab` class is used to generate the tab components:

```php
use Tianc\Admin\Widgets\Tab;
...
`Tianc\Admin\Widgets\Table` class is used to generate tables:

```php
use Tianc\Admin\Widgets\Table;
