...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'tenant-admin:install';
    ...
    public function initDatabase()
    {
        ...
        if ($userModel::count() == 0) {
            $this->call('db:seed', ['--class' => \Tianc\Admin\Auth\Database\AdminTablesSeeder::class]);
        }
    }
    ...
    {
        $this->directory = config('tenant-admin.directory');
    ...
    public function createHomeController()
    {
        ...
        $this->laravel['files']->put(
            $homeController,
            str_replace('DummyNamespace', config('tenant-admin.route.namespace'), $contents)
        );
    ...
    protected function createRoutesFile()
    {
        ...
        $this->laravel['files']->put($file, str_replace('DummyNamespace', config('tenant-admin.route.namespace'), $contents));
